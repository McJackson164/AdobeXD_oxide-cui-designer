...
class CUIText extends CUITextElement {
    /**
     * @param {String} name
     * @param {String} parent
     ...
     * @param {Number} fade
     */
    constructor(name, parent, color, text, fontSize, xAnchorMin, xAnchorMax, yAnchorMin, yAnchorMax, textAlignment = TextAlignment.LEFT, cursor = false, fade = 1.0) {
